...
OGP_URL = os.getenv('OGP_URL', "https://geodata.tufts.edu/solr/select")
...
OGC_SERVER_DEFAULT_PASSWORD = os.getenv(
    'GEOSERVER_ADMIN_PASSWORD', 'Bma!GeoS_19@'
)
...
# ALLOWED_HOSTS = ['geonode-rris.biopama.org', 'h05-stg-vm14.ies.jrc.it', 'h05-dev-vm36.ies.jrc.it', 'h05-srv-dbp96.jrc.it', '139.191.147.129', 'pgsql-dev2.jrc.it']
...
1. pip install django-geonode-client==1.0.9
2. enable those:
"""
...
#THUMBNAIL_GENERATOR_DEFAULT_BG = r"https://a.tile.openstreetmap.org/{z}/{x}/{y}.png"
